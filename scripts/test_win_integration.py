...
print('\n=== Macro ===')
_STRATEGY.set_macro_global('__px_gtest', 'hello_world')
print('  get_macro_global:', repr(_STRATEGY.get_macro_global('__px_gtest')))
_STRATEGY.set_macro_local('__px_ltest', 'local_val')
print('  get_macro_local:', repr(_STRATEGY.get_macro_local('__px_ltest')))
